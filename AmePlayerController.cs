...
public class AmePlayerController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            //If chacter is on the ground make ySpeed = 0 so that we don't get a weird bug I can't fix cuz Im too dum- I mean prevent ySpeed from 
            //decreasing leading to instant big gravity pulls
